Spring Batch In-Memory [![Build Status](https://github.com/marschall/spring-batch-inmemory/actions/workflows/maven.yml/badge.svg?branch=master)](https://github.com/marschall/spring-batch-inmemory/actions?query=branch%3Amaster) [![Maven Central](https://img.shields.io/maven-central/v/com.github.marschall/spring-batch-inmemory?color=31c653&label=maven%20central)](https://central.sonatype.com/artifact/com.github.marschall/spring-batch-inmemory) [![Javadocs](https://www.javadoc.io/badge/com.github.marschall/spring-batch-inmemory.svg)](https://www.javadoc.io/doc/com.github.marschall/spring-batch-inmemory)
======================
